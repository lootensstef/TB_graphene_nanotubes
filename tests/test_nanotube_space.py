...
def test_nanotube_symmetryline_shape():
    ...
    gamma_to_x_1 = nanotube_space.nanotube_symmetryline(
        k_gamma_1, k_z_1, 3, 50)
    gamma_to_x_2 = nanotube_space.nanotube_symmetryline(
        k_gamma_2, k_z_2, 3, 50)
    gamma_to_x_3 = nanotube_space.nanotube_symmetryline(
        k_gamma_3, k_z_3, 3, 50)
...
def test_nanotube_symmetrylines_valid_output():
    ...
    gamma_to_x_1 = nanotube_space.nanotube_symmetryline(
        k_gamma_1, k_z_1, 2, 50)
    gamma_to_x_2 = nanotube_space.nanotube_symmetryline(
        k_gamma_2, k_z_2, 2, 50)
    gamma_to_x_3 = nanotube_space.nanotube_symmetryline(
        k_gamma_3, k_z_3, 2, 50)
