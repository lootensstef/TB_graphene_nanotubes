...
def material_selector():
    ...
    while True:
        material = input(
            "Choose a material to simulate (graphene/nanotube): ").lower()
            ...
            while True:
                ...
                try:
                    ...
                    if (n < 0 or m < 0) or (n < 1 and m < 1):
                        print(
                            "Invalid input, integers must be non negative with at least one different from zero \n")
                    else:
                        break
                except ValueError:
...
def energyparams_selector():
    ...
    while True:
        ...
        decision = input(
            "Would you like custom tight-binding parameters? (y/n): ").lower()
